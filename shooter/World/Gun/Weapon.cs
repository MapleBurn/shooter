...
public partial class Weapon : Node3D
{
    ...
    private Player.Player _ownerPlayer;
    ...
    public override void _Ready()
    {
        ...
        _ownerPlayer = GetParent<Player.Player>();
    ...
    public override void _Process(double delta)
    {
        ...
        if (Player.Player.IsGamePaused) return;
    ...
    private void Fire()
    {
        ...
        World.Gun.BulletManager.Instance.SpawnBullet(_muzzle.GlobalPosition, shootDir, _bulletSpeed, _bulletPenetration);
